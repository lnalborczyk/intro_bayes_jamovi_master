...
date: '30.09.2021 <br><br> `r icons::icon_style(icons::fontawesome(name = "twitter"), fill = "white")` <a href="https://twitter.com/lnalborczyk" style="color:white;">@lnalborczyk</a> `r icons::icon_style(icons::fontawesome("link"), fill = "white")` Slides >> <a href="https://tinyurl.com/introbayes2021" style="color:white;"> tinyurl.com/introbayes2021</a>'
output:
...
Le matériel de l'édition 2021 de la formation doctorale que j'organise : "Introduction à la modélisation statistique bayésienne en R" ([slides + code](https://github.com/lnalborczyk/IMSB2021)).
